<script lang="ts">
  ...
  function generateStars() {
    ...
    const starCounts = [
      { count: 1/2 * 100, sizeRange: [6, 8], opacityRange: [0.95, 1] },      // Brightest stars
      { count: 1/2 * 300, sizeRange: [4, 6], opacityRange: [0.85, 0.95] },   // Very bright stars
      { count: 1/2 * 800, sizeRange: [3, 4], opacityRange: [0.7, 0.85] },    // Bright stars
      { count: 1/2 * 2000, sizeRange: [2, 3], opacityRange: [0.5, 0.7] },    // Medium stars
      { count: 1/2 * 4000, sizeRange: [1.5, 2], opacityRange: [0.35, 0.5] }, // Faint stars
      { count: 1/2 * 6000, sizeRange: [1, 1.5], opacityRange: [0.25, 0.35] },// Very faint stars
      { count: 1/2 * 3000, sizeRange: [0.7, 1], opacityRange: [0.15, 0.25] },// Barely visible
    ];
