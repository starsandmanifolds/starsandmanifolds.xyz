                  ...
                  <div class="flex items-start justify-between gap-4">
                    {#if project.githubUrl}
                      ...
                      >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" class="w-3.5 h-3.5 text-neutral-400 dark:text-neutral-600 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
