...
<svelte:head>
  ...
  <meta name="description" content="Technical skills and expertise of {SITE_CONFIG.name}." />
</svelte:head>
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          {#each Object.entries(skillsByCategory) as [category, skills]}
            <div>
              <h2 class="text-xl font-semibold mb-4 text-neutral-800 dark:text-neutral-200">
